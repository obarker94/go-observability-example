...
const traceDefaults = {
  ...
  randomEvents: {
    generateExceptionOnError: true,
    rate: 1.0,
    randomAttributes: { count: 2, cardinality: 3 },
  },
  ...
  },
  {
    ...
    spans: [
      ...
      { service: "shop-backend", name: "place-articles", parentIdx: 0 },
      {
        ...
        name: "place-articles",
        attributes: { "article.count": 1, "http.status_code": 201 },
      },
  ...
  },
  {
    ...
    spans: [
      { service: "shop-backend", attributes: { "http.status_code": 403 } },
      {
        service: "shop-backend",
        name: "authenticate",
        attributes: { "http.request.header.accept": ["application/json"] },
      },
      {
    ...
    spans: [
      ...
      },
      {
        ...
        randomEvents: {
          exceptionRate: 1,
          rate: 2,
          randomAttributes: { count: 5, cardinality: 2 },
        },
      },
      {
        ...
        randomLinks: {
          rate: 2,
          randomAttributes: { count: 3, cardinality: 2 },
        },
      },
    ],
  },
